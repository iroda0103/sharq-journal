...
"investment", "innovation", "modernization", "industrial development"],
    ...
    },
    {
      ...
      year: "2026",
      abstract: {
        uz: `азкур мақолада Ўзбекистон Республикасида 2026 йил учун 
...
muhim ilmiy ahamiyat kasb etadi`,
    ...
    },
    {
      ...
      title: {
        uz: "",
        ru: "",
        en: "EDAGOGICAL AND PSYCHOLOGICAL FOUNDATIONS OF AIBASED METHODOLOGICAL TRAINING FOR FUTURE PRIMARY ",
      },
...
contexts`      },
    ...
    },
    {
      ...
      language: "O'zbek",
      keywords: {
        uz: ["oliy ta'lim", "raqamlashtirish", "ta'limdagi innovatsiyalar", "shaffoflik", "xolislik va adolatlilik prinsiplari"],
        ru: [],
        en: [],
      },
    ...
    },
    {
      ...
      year: "2026",
      abstract: {
        uz: "Maqolada internet reklama tilida ingliz va o'zbek tillarida derivatsiya jarayonining qiyosiy tahlili amalga oshirilgan. So'z yasalish qonuniyatlari va reklama tili xususiyatlari ko'rib chiqilgan.",
        ru: "",
        en: "",
      },
      pages: "171-185",
    ...
    },
    {
      ...
      abstract: {
        uz: "",
        ru: "В статье рассматривается организация Навоийского областного государственного архива и классификация архивных фондов. Анализируется структура и принципы систематизации документов.",
        en: "",
      },
      pages: "186-198",
      publishDate: "19.01.2026",
      ...
      keywords: {
        uz: [],
        ru: ["архив", "Навоийская область", "классификация фондов", "документы"],
        en: [],
      },
    ...
    },
    {
      ...
      year: "2026",
      abstract: {
        uz: "Maqolada talabalarda tolerantlik xususiyatlarini shakllantirishning ilmiy-nazariy asoslari ko'rib chiqilgan. Tolerantlik tushunchasi va uni rivojlantirish yo'llari tahlil qilingan.",
        ru: "",
        en: "",
      },
      pages: "199-207",
      ...
      language: "O'zbek",
      keywords: {
        uz: ["tolerantlik", "talabalar", "ilmiy-nazariy asos", "shaxs shakllantirish"],
        ru: [],
        en: [],
      },
